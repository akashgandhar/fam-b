...
router.post('/upload-frame', uploadP.fields([
    {
        name: 'file',
        maxCount: 1
    }

]),converter, UserController.uploadPhoto);
router.post('/order-confirm', verifyUserJWTToken, asyncTryCatchMiddleware(UserController.Confirmation))
